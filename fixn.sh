    ...
    if [ ! "$IGNORE" -a ! -e "$LOG" ]; then
      ...
      case $i in
        temp/dapr/dapr|temp/dapr/kit)
          CMD="go vet -vettool=$CMPLINT -tags=unit"
          ;;
        *)
          CMD="$CMPLINT"
          ;;
      ...
      find $i -type d \(\
        ...
        -path temp/capnproto/go-capnp/example -o \
        ...
        -path temp/etcd-io/raft/tools/mod -o \
        -path temp/flyteorg/flyte/boilerplate/flyte/golang_support_tools -o \
        ...
        -path temp/hashicorp/go-secure-stdlib/configutil -o \
        -path temp/hashicorp/vault/tools/pipeline -o \
        -path temp/hashicorp/vault/vault/hcp_link/proto -o \
        ...
        -path temp/mongodb/mongo-go-driver/internal/test/compilecheck -o \
        -path temp/muesli/termenv/examples/ssh -o \
        ...
        -path temp/openbao/go-secure-stdlib/plugincontainer -o \
        -path temp/ory/hydra/internal/httpclient -o \
        -path temp/ory/keto/.bin -o \
        -path temp/ory/kratos/internal/client-go -o \
        -path temp/ory/kratos/test/e2e/mock/httptarget -o \
        -path temp/ossf/scorecard/tools -o \
        -path temp/prometheus/prometheus/internal/tools -o \
        -path temp/reddit/achilles-sdk/tools -o \
        -path temp/redpanda-data/connect/public/bundle -o \
        -path temp/RichardKnop/machinery/v2 -o \
        -path temp/samber/do/examples -o \
        -path temp/samber/do/http -o \
        -path temp/segmentio/encoding/benchmarks -o \
        -path temp/segmentio/encoding/proto/fixtures -o \
        ...
        -path temp/snyk/policy-engine/pkg/input/schemas/tf/generate -o \
        ...
        -path temp/TykTechnologies/tyk/ci -o \
